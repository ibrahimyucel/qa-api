...
/*
	...
	File: qa-plugin/social-login/qa-open-widget.php
	Version: 3.0.0
...
*/
	...
	class qa_social_login_widget {
		...
		function output_widget($region, $place, $themeobject, $template, $request, $qa_content) {
			...
			$themeobject->output(
				'<div class="social-login-sidebar">',
				qa_lang_html('social_login/login_title'),
				'</div>',
				'<p class="social-login-sidebar-buttons">'
			);
