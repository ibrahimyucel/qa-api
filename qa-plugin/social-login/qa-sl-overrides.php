...
/*
	...
	File: qa-plugin/social-login/qa-open-overrides.php
	Version: 3.0.0
...
function qa_log_in_external_user($source, $identifier, $fields)
{
	...
	$remember = qa_opt('social_login_remember') ? true : false;
	...
	$aggsource = qa_social_login_get_new_source($source, $identifier);
